...
namespace BudCopyListen.DBService
{
    public class MonitorServerFolderService : IMonitorServerFolderService
    {
        ...
        public List<Entities.monitorServerFolder> Search(int monitorServerID, string monitorFileName, string monitorFilePath, string monitorFileType, int deleteFlg)
        {
            ...
            string paraMonitorFileName = string.IsNullOrEmpty(monitorFileName) ? " 1=1 " : " monitorFileName = " + "'" + monitorFileName + "'";

            string paraMonitorFilePath = string.IsNullOrEmpty(monitorFilePath) ? " 1=1 " : " monitorFilePath = " + "'" + monitorFilePath + "'";
