...
namespace BudCopyListen.Mapping
{
	public class monitorFileListenMap : EntityTypeConfiguration<monitorFileListen>
	{
		public monitorFileListenMap()
		{
			...
			this.Property(t => t.monitorFileRelativeDirectory)
				.IsRequired()
				.HasMaxLength(500);
				
			this.Property(t => t.monitorFileRelativeFullPath)
				.IsRequired()
				.HasMaxLength(500);
			...
			this.Property(t => t.sharePoint).HasColumnName("sharePoint");
			this.Property(t => t.monitorLocalPath).HasColumnName("monitorLocalPath");
			this.Property(t => t.monitorFileRelativeDirectory).HasColumnName("monitorFileRelativeDirectory");
			this.Property(t => t.monitorFileRelativeFullPath).HasColumnName("monitorFileRelativeFullPath");
