...
namespace BudSSH.Common.Util
{
    ...
    public class LogManager
    {
        ...
        public static void WriteLog(LogFile logFile,System.Exception e)
        {
        ...
        /// <param name="logFile">日志名称</param>
        /// <param name="e">异常信息</param>
        public static void WriteLogFirstLayer(LogFile logFile,System.Exception e)
        {
            ...
            if (e.StackTrace != null)
            {
                ...
                message = e.Message + Environment.NewLine + lines[lines.Length - 1];
            }
            else
            {
                message = e.Message;
            ...
            WriteLog(logFile.ToString(), message);
        }
    }
