...
namespace DBUtility
{
    public class OdbcDatabase
    {
        ...
        ///     false:未打开
        /// </returns>
        public bool CheckConn(OdbcConnection conn)
        {
            bool flag = false;
        ...
        public void CloseConnection(OdbcConnection sconn)
        {
            if (sconn != null)
            {
                sconn.Close();
        ...
        /// <returns></returns>
        public DataSet Squery(string name, OdbcParameter[] parameters, OdbcConnection sconn)
        {
            try
            {
                ...
                OdbcDataAdapter dp = new OdbcDataAdapter(cmd);
        ...
        /// <param name="sql">要执行的sql语句</param>
        /// <returns></returns>
        public DataTable Squery(string sql, OdbcConnection sconn)
        {
            try
            {
                DataTable dt = new DataTable();
                OdbcDataAdapter sda = new OdbcDataAdapter(sql, sconn);
                sda.Fill(dt);
                return dt;
            }
            catch (Exception e)
        ...
        public DataTable Squery(string sql, OdbcConnection sconn, OdbcTransaction stran)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        /// <param name="stran">事务</param>
        /// <returns>查询结果datatable</returns>
        public DataTable Squery(string sql, OdbcConnection sconn, OdbcTransaction stran, params OdbcParameter[] values)
        {
            try
            {
                DataTable dt = new DataTable();
                OdbcCommand scom = new OdbcCommand(sql, sconn);
                scom.Parameters.AddRange(values);
                scom.Transaction = stran;
                OdbcDataAdapter sda = new OdbcDataAdapter(scom);
                sda.Fill(dt);
                return dt;
            }
            catch (Exception e)
        ...
        public DataTable Squery(string sql, OdbcConnection sconn, params OdbcParameter[] values)
        {
            try
            {
                DataTable dt = new DataTable();
                OdbcCommand scmd = new OdbcCommand(sql, sconn);
                scmd.Parameters.AddRange(values);
                OdbcDataAdapter sda = new OdbcDataAdapter(scmd);
                sda.Fill(dt);
                return dt;
            }
            catch (Exception e)
        ...
        /// <param name="sql">要执行的sql语句</param>
        /// <param name="sconn">数据库连接</param>
        public int Udaquery(string sql, OdbcConnection sconn)
        {
            try
            {
                OdbcCommand scom = new OdbcCommand(sql, sconn);
        ...
        /// <param name="sql">要执行的sql语句</param>
        /// <param name="sconn">数据库连接</param>
        public int Udaquery(string sql, OdbcConnection sconn, params OdbcParameter[] values)
        {
            try
            {
                OdbcCommand scom = new OdbcCommand(sql, sconn);
        ...
        public int Udaquery(string sql, OdbcConnection sconn, OdbcTransaction strans)
        {
            try
            {
                OdbcCommand scom = new OdbcCommand(sql, sconn);
        ...
        /// <param name="sconn">数据库连接</param>
        /// <param name="strans">事务</param>
        public int Udaquery(string sql, OdbcConnection sconn, OdbcTransaction strans, params OdbcParameter[] values)
        {
            try
            {
                OdbcCommand scom = new OdbcCommand(sql, sconn);
        ...
        /// <param name="sql">要执行的sql语句</param>
        /// <param name="sconn">数据库连接</param>
        public int GetInfol(string sql, OdbcConnection sconn)
        {
            int num = 0;
            try
            {
        ...
        /// <returns>总行数</returns>
        public int GetCount(OdbcConnection sconn, string tblName, string strWhere = "")
        {
            string sqlStr = "";
        ...
        /// <returns>DataTable</returns>
        public DataTable GetDataTable(int pageNum, int psize, OdbcConnection sconn, string tblName, string[] ary_fields, string strWhere = "", string orders = "")
        {
            try
            {
                int seltop = 0;
        ...
        /// <param name="tblName">要查询的表名</param>
        /// <returns>DataTable</returns>
        public DataTable GetDataJoinTable(int pageNum, int psize, OdbcConnection sconn, string tblName1, string[] ary_fields, string tblName2, string orders = "")
        {
            try
            {
                int seltop = 0;
        ...
        public OdbcTransaction stran;//事物处理
        ...
        /// <returns></returns>
        public int getCountByModel(OdbcConnection conn, Object o, string tableName)
        {
            Hashtable ht = getModelValue(o);//获取有效数据
            int paramCount = ht.Count;
            OdbcParameter[] sp = new OdbcParameter[paramCount];//创建OdbcParameter参数数组
            string sql = getQueryCountSql(ht, tableName, sp);//生成sql 装载OdbcParameter
            DataTable dt = null;
            if (ht.Count != 0)
            {
        ...
        /// <param name="stran">事务</param>
        /// <returns></returns>
        public int delete(Object o, string tableName, OdbcConnection conn, OdbcTransaction stran = null)
        {
            Hashtable ht = getModelValue(o);//有效数据
            int paramCount = ht.Count;
            OdbcParameter[] sp = new OdbcParameter[paramCount];
        ...
        /// <param name="stran">事务</param>
        /// <returns></returns>
        public int insert(Object o, string tableName, OdbcConnection conn, OdbcTransaction stran = null)
        {
            Hashtable ht = getModelValue(o);//有效数据
            int paramCount = ht.Count;
            OdbcParameter[] sp = new OdbcParameter[paramCount];
        ...
        public int update(OdbcConnection conn, Object o, string tableName, String[] wheres, OdbcTransaction stran = null)
        {
        ...
        /// <param name="stran"></param>
        /// <returns>-1失败0成功</returns>
        public int update(OdbcConnection conn, Object o, string sql, OdbcTransaction stran = null)
        {   //有效数据
            Hashtable ht = getModelValue(o, updateAll);
            OdbcParameter[] sp = new OdbcParameter[ht.Count];
        ...
        public Object getByModel(OdbcConnection conn, Object o, string tableName)
        {   //有效数据
        ...
        public Object getBySQL(OdbcConnection conn, Object o, string sql)
        {
            Hashtable ht = getModelValue(o);//有效数据
            int paramCount = ht.Count;
            //if (ht.Count == 0)
        ...
        public Object getListBySQL(OdbcConnection conn, Object o, string p_sql)
        {   //取得有效数据
            Hashtable ht = getModelValue(o);
            //创建sql参数列表
            OdbcParameter[] sp = new OdbcParameter[ht.Count];
        ...
        public Object getListByModel(OdbcConnection conn, Object o, string tableName)
        {   //获取model中的有效数据
            Hashtable ht = getModelValue(o);
            //创建参数列表
            OdbcParameter[] sp = new OdbcParameter[ht.Count];
                ...
                foreach (PropertyInfo item in FieldInfos)
                {
                    ...
                    switch (item2.PropertyType.ToString())
                    {
                        case "System.String":
                            ...
                            break;
                        case "System.Int16":
                            if ((item2.GetValue(o, null) != null && Convert.ToInt16(item2.GetValue(o, null)) != -1) || all)
                            {
                                ht.Add(name, item2.GetValue(o, null));
                            }
                            break;
        ...
        /// By:wangjianxu 2012-05-22
        /// </summary>
        private string getQuerySql(Hashtable ht, string tableName, OdbcParameter[] sp)
        {
            ...
            if (ht.Count != 0)
            {
                ...
                while (ide.MoveNext())
                {
                    sonsql += " and " + ide.Key.ToString() + "= ? ";
                    sp[nownumer] = new OdbcParameter("@" + ide.Key.ToString(), ide.Value.ToString());
                    nownumer++;
        ...
        /// <returns></returns>
        private string getUpdateSql(Hashtable ht, string tableName, OdbcParameter[] sp, String[] wheres)
        {
            //if (ht.Count == 0)
            //{
            ...
            while (ide.MoveNext())
            {   //排除条件字段
                if (Array.BinarySearch(wheres, ide.Key.ToString()) < 0)
                {
                    setSql += ", " + ide.Key.ToString() + "= ? " ;

                }
                sp[nownumer] = new OdbcParameter("@" + ide.Key.ToString(), ide.Value == null ? "" : ide.Value.ToString());
                nownumer++;
        ...
        private string getInsertSql(Hashtable ht, string tableName, OdbcParameter[] sp)
        {
            //if (ht.Count == 0)
            //{
        ...
        private string getDeleteSql(Hashtable ht, string tableName, OdbcParameter[] sp)
        {
            if (ht.Count == 0)
            {
            ...
            while (ide.MoveNext())
            {
                ...
                sp[nownumer] = new OdbcParameter("@" + ide.Key.ToString().ToUpper(), ide.Value.ToString());
                nownumer++;
        ...
        private string getQueryCountSql(Hashtable ht, string tableName, OdbcParameter[] sp)
        {
