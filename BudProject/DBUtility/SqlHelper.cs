...
namespace DBUtility
{
    ...
    {
        //数据库连接字符串
        public static readonly string connectString = System.Configuration.ConfigurationManager.AppSettings["ConnStringAllForSqlserver"];
        ...
        /// <returns></returns>
        public static DataTable Squery(string sql, SqlConnection sconn)
        {
            try
            {
