...
namespace DBUtility
{
    ...
    {
        //数据库连接字符串
        public static readonly string connectString = System.Configuration.ConfigurationManager.AppSettings["ConnString"];
        public static OdbcConnection CreateConntion()
        {
            return new OdbcConnection(connectString);
        }
        //统合DB连接——2014-06-03 wjd add
        public static readonly string connectStringAll = System.Configuration.ConfigurationManager.AppSettings["ConnStringAll"];
        public static OdbcConnection CreateConntionAll()
        {
            return new OdbcConnection(connectStringAll);
        }
        ...
        public static OdbcDataReader ExecuteReader(string connectionString, CommandType cmdType, string cmdText, params OdbcParameter[] commandParameters)
        {
            ...
            try
            {
                //调用 PrepareCommand 方法，对 OdbcCommand 对象设置参数
                PrepareCommand(cmd, conn, null, cmdType, cmdText, commandParameters);
                //调用 OdbcCommand  的 ExecuteReader 方法
        ...
        public static OdbcDataReader ExecuteReader(OdbcConnection connection, CommandType cmdType, string cmdText, params OdbcParameter[] commandParameters)
        {
            OdbcCommand cmd = new OdbcCommand();
            PrepareCommand(cmd, connection, null, cmdType, cmdText, commandParameters);
        ...
        /// <returns></returns>
        public static DataTable Squery(string sql, OdbcConnection sconn)
        {
            try
            {
        ...
        public static DataTable Squery(string sql, OdbcConnection sconn, params OdbcParameter[] values)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        /// <param name="values">需要传入的参数</param>
        /// <returns>datatable</returns>
        public static DataTable Squery(string sql, OdbcConnection sconn, OdbcTransaction trans, params OdbcParameter[] values)
        {
